...
#Currently either "vid_1.mp4" or "vid_0.mov"
filename = ("vid_0.mov")
...
plt.show()
fig.savefig(os.path.join("data", 'rsignal_'+filename+'.png'))
...
plt.plot(rrate)
plt.show()
fig1.savefig(os.path.join("data", 'bpm_'+filename+'.png'))# Use fig. here
